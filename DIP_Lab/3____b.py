...
avg2 = cv2.blur(noisy_image, (5, 5))
avg3 = cv2.blur(noisy_image, (7, 5))

plot(3 , "average filter in 3 x 3 ", avg1)
plot(4 , "average filter in 5 x 5 ", avg2)
plot(5 , "average filter in 7 x 7 ", avg3)



psnr_avg1 = psnr(image_matrix, avg1)
psnr_avg2 = psnr(image_matrix, avg2)
psnr_avg3 = psnr(image_matrix, avg3)

print(f"PSNR of Average Filter: {psnr_avg1:.5f} dB")
print(f"PSNR of Average Filter: {psnr_avg2:.5f} dB")
print(f"PSNR of Average Filter: {psnr_avg3:.5f} dB")
